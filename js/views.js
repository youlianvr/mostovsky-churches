...
(function () {
  ...
  function renderHome() {
    ...
    app.innerHTML = '<section class="hero"><h1>Храмы Мостовского района</h1><p>Маршрут по 19 храмам Мостовского района Гродненской области — 12 православных церквей и 7 католических костёлов, от старейшего деревянного храма 1740 года до новейшей церкви 2022 года.</p></section><section class="map-schema" aria-label="Схема маршрута"><div class="legend"><span class="legend-item"><span class="marker-sample orthodox"></span> православный храм</span><span class="legend-item"><span class="marker-sample"></span> католический костёл</span></div></section><section><h2>Остановки маршрута</h2><ol class="route-list">' + items + '</ol></section>';
