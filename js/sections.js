...
(function () {
  ...
  function renderMap() {
    ...
    H.paint('<h1>Карта-схема маршрута</h1>' +
      '<p class="page-lead">Схема маршрута на реальной географии: границы района, Нёман и дороги — данные OpenStreetMap; коричневая пунктирная нить — путь маршрута по автодорогам от Гродно через Гудевичи и Лунно к Дубно и Мостам. Номер у иконки — шаг маршрута, клик по иконке открывает страницу храма.</p>' +
